<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="公司名称" prop="gongsimingcheng">
					<el-select :disabled="ro.gongsimingcheng" @change="gongsimingchengChange" v-model="ruleForm.gongsimingcheng" placeholder="请选择公司名称">
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.gongsimingcheng" label="公司名称" prop="gongsimingcheng">
					<el-input v-model="ruleForm.gongsimingcheng" placeholder="公司名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="公司地址" prop="gongsidizhi">
					<el-input v-model="ruleForm.gongsidizhi" placeholder="公司地址" clearable  :readonly="ro.gongsidizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="公司地址" prop="gongsidizhi">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="性别" prop="xingbie">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="申请时间" prop="shenqingshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shenqingshijian" label="申请时间" prop="shenqingshijian">
					<el-input v-model="ruleForm.shenqingshijian" placeholder="申请时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="签约说明" prop="qianyueshuoming">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="签约说明"
					  v-model="ruleForm.qianyueshuoming" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qianyueshuoming" label="签约说明" prop="qianyueshuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.qianyueshuoming}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="签约材料" prop="qianyuecailiao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.qianyuecailiao" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qianyuecailiao" label="签约材料" prop="qianyuecailiao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.qianyuecailiao"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				fuzeren : false,
				tupian : false,
				qianyueshuoming : false,
				qianyuecailiao : false,
			...
			rules: {
				...
				qianyuecailiao: [
					{ required: true, message: '签约材料不能为空', trigger: 'blur' },
				],
				jiazhengzhanghao: [
				],
				jiazhengxingming: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='qianyueshuoming'){
							this.ruleForm.qianyueshuoming = obj[o];
							this.ro.qianyueshuoming = true;
							continue;
						}
						if(o=='qianyuecailiao'){
							this.ruleForm.qianyuecailiao = obj[o];
							this.ro.qianyuecailiao = true;
							continue;
						}
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.gongsimingchengOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.qianyuecailiao = this.ruleForm.qianyuecailiao.replace(reg,'../../../springbootx1f0vrd9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `jiazhengqianyue/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jiazhengqianyueCrossAddOrUpdateFlag = false;
											this.parent.search();
