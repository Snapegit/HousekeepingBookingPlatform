        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"0","cursor":"pointer","padding":"0 14px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"5px","background":"#0E9BD3","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"
