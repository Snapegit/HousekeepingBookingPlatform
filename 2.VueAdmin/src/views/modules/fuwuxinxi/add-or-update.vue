	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0 30px","background":"#fff"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="服务时间" prop="fuwushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.fuwushijian" label="服务时间" prop="fuwushijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="发布日期" prop="faburiqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="服务内容" prop="fuwuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.fuwuneirong" label="服务内容" prop="fuwuneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fuwuneirong"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.fangzhuxingming!=''&&json.fangzhuxingming) || json.fangzhuxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.fangzhuxingming = json.fangzhuxingming
						this.ro.fangzhuxingming = true;
					}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fuwuneirong = this.ruleForm.fuwuneirong.replace(reg,'../../../springbootx1f0vrd9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
