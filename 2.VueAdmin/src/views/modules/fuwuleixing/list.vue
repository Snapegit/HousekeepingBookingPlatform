		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- 无 -->
					<el-table-column :resizable='true' :sortable='false' prop="image" width="200" label="图片">
						<template slot-scope="scope">
							<div v-if="scope.row.image">
								<img v-if="scope.row.image.substring(0,4)=='http'" :src="scope.row.image.split(',')[0]" width="100" height="100" style="object-fit: cover">
								<img v-else :src="$base.url+scope.row.image.split(',')[0]" width="100" height="100" style="object-fit: cover">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
