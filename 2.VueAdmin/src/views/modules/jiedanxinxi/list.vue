<template>
	<div class="main-content" :style='{"width":"calc(100% - 60px)","padding":"30px","margin":"0 30px","background":"#fff"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('jiedanxinxi','反馈')" @click="jiedanfankuiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<jiedanfankui-cross-add-or-update v-if="jiedanfankuiCrossAddOrUpdateFlag" :parent="this" ref="jiedanfankuiCrossaddOrUpdate"></jiedanfankui-cross-add-or-update>
...
import jiedanfankuiCrossAddOrUpdate from "../jiedanfankui/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				jiedanfankuiCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			jiedanfankuiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.jiedanfankuiCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.jiedanfankuiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.jiedanfankuiCrossaddOrUpdate.init(row.id,type);
				});
			},
