<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0 0","margin":"10px 30px 0","borderColor":"#d8dce5","background":"#fff","borderWidth":"0","width":"calc(100% - 60px)","borderStyle":"solid","height":"34px"}'>
